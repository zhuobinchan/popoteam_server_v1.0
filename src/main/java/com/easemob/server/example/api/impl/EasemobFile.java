...
public class EasemobFile implements FileAPI {
    ...
    @Override
    public Object uploadFile(final Object file) throws HuanxinResponseException {
    ...
    @Override
    public Object downloadFile(final String fileUUID,final  String shareSecret,final Boolean isThumbnail) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
