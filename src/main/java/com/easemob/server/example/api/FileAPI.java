...
public interface FileAPI {
	 ...
	 * @return
	 */
	Object uploadFile(Object file) throws HuanxinResponseException;
	 ...
	 * @return
	 */
	Object downloadFile(String fileUUID, String shareSecret, Boolean isThumbnail) throws HuanxinResponseException;
}
