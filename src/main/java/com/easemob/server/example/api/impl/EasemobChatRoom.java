...
public class EasemobChatRoom implements ChatRoomAPI {
    ...
    @Override
    public Object createChatRoom(final Object payload) throws HuanxinResponseException {
    ...
    @Override
    public Object modifyChatRoom(final String roomId,final Object payload) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object deleteChatRoom(final String roomId) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object getAllChatRooms() throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object getChatRoomDetail(final String roomId) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object addSingleUserToChatRoom(final String roomId,final String userName) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object addBatchUsersToChatRoom(final String roomId,final Object payload) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object removeSingleUserFromChatRoom(final String roomId,final String userName) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object removeBatchUsersFromChatRoom(final String roomId,final String[] userNames) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
