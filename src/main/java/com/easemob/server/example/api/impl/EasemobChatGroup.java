...
public class EasemobChatGroup implements ChatGroupAPI {
    ...
    @Override
    public Object getChatGroups(final Long limit,final String cursor) throws HuanxinResponseException {
    ...
    @Override
    public Object getChatGroupDetails(final String[] groupIds) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object createChatGroup(final Object payload) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object modifyChatGroup(final String groupId,final Object payload) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object deleteChatGroup(final String groupId) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object getChatGroupUsers(final String groupId) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object addSingleUserToChatGroup(final String groupId,final String userId) throws HuanxinResponseException {
    ...
    @Override
    public Object addBatchUsersToChatGroup(final String groupId,final Object payload) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object removeSingleUserFromChatGroup(final String groupId,final String userId) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object removeBatchUsersFromChatGroup(final String groupId,final String[] userIds) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object transferChatGroupOwner(final String groupId,final Object payload) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object getChatGroupBlockUsers(final String groupId) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object addSingleBlockUserToChatGroup(final String groupId,final String userId) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object addBatchBlockUsersToChatGroup(final String groupId,final Object payload) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object removeSingleBlockUserFromChatGroup(final String groupId,final String userId) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
    ...
    @Override
    public Object removeBatchBlockUsersFromChatGroup(final String groupId,final String[] userIds) throws HuanxinResponseException {
        return responseHandler.handle(new EasemobAPI() {
            @Override
            public Object invokeEasemobAPI() throws ApiException {
